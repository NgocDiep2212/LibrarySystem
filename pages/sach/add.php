        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="./index.php?act=addS" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <input required="true" type="text" class="form-control" id="type" name="type" value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                ...
                                <input required="true" type="text" class="form-control" id="conlai" name="conlai" value="">
                        </div>
                        <?php 
                    if(isset($_GET['error'])){
